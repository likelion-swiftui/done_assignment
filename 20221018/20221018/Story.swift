...
//
//import SwiftUI
////#-learning-task(writeTheStory)
//
///*#-code-walkthrough(Models.storyInitializer)*/
//let story = Story(pages: [
///*#-code-walkthrough(Models.storyInitializer)*/
//    StoryPage( // 0
//        /*#-code-walkthrough(Models.storyPageInitializer.multilineStringLiteral)*/
//        """
...
//        """,
//        /*#-code-walkthrough(Models.storyPageInitializer.multilineStringLiteral)*/
//        /*#-code-walkthrough(Models.storyPageInitializer.choicesArray)*/
//        choices: [
//            /*#-code-walkthrough(Models.storyPageInitializer.choice)*/
...
//        /*#-code-walkthrough(Models.storyPageInitializer.choicesArray)*/
//    ),
//    /*#-code-walkthrough(Models.storyPageInitializer.addPage)*/
//    StoryPage( // 1
//        """
